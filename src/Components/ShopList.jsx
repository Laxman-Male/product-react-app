        ...
        <>
          ...
          <button onClick={removeItem} className="self-start px-3 border border-red-500 bg-red-300 rounded-lg font-semibold text-lg h-10 mt-2">
            Remove from Cart
                ...
                {/* <div className='border border-black  grid-cols-none  flex flex-col '>
                  
                    <img className='   sm:w-56 ssm:w-3/4 md:w-3/4    h-52   relative  items-center shadow-xl shadow-violet-700/80   p-0 m-10 mb-3 mt-2      rounded-2xl   ' src='img/e1.jpg' />
                </div> */}
            </div>
